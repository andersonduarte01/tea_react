...
type Route = RouteProp<AppStackParams, 'ProfissionalNovaSenha'>;
...
export function ProfissionalNovaSenhaScreen() {
  ...
  const handleSave = async () => {
    ...
    setSaving(true);
    try {
      await api.post(`/api/v1/profissional/${params.id}/reset-senha/`, {
    ...
    <SafeAreaView style={s.root} edges={['top']}>
      ...
      <View style={s.header}>
        ...
        <View style={{ flex: 1 }}>
          ...
          <Text style={s.headerSub}>Redefinir senha do profissional</Text>
        </View>
      </View>
